...
//  FoodTracker
//
//  Created by Loris Mazloum on 8/7/16.
...
class MealTableViewController: UITableViewController {
    ...
    func loadSampleMeals() {
        ...
        let meal1 = Meal(name: "Fish'n'chips", photo: photo1, rating: 4)!
        
        let photo2 = UIImage(named: "meal2")!
        let meal2 = Meal(name: "Chicken Brie Salad", photo: photo2, rating: 5)!
        
        let photo3 = UIImage(named: "meal3")!
        let meal3 = Meal(name: "Pho Stew", photo: photo3, rating: 5)!
        
        let photo4 = UIImage(named: "meal4")!
        let meal4 = Meal(name: "Chicken Salad", photo: photo4, rating: 3)!
